...
class BootimgEFIPlugin(SourcePlugin):
    ...
    name = 'bootimg-efi-grubenv'

    @classmethod
    def do_configure_grubefi(cls, hdddir, creator, cr_workdir, source_params, native_sysroot):
        """
        ...
        # create grubenv file:
        cmd_envcreate = "grub-editenv %s/hdd/boot/EFI/BOOT/grubenv create" % cr_workdir
        exec_cmd(cmd_envcreate, native_sysroot)
    ...
    def do_configure_partition(cls, part, source_params, creator, cr_workdir,
        ...
        try:
            if source_params['loader'] == 'grub-efi':
                cls.do_configure_grubefi(hdddir, creator, cr_workdir, source_params, native_sysroot)
