...
#
# DESCRIPTION
# This implements the 'bootimg-grub' source plugin class for 'wic'
#
#
# This file is derived from bootimg-grup-tb.py by:
...
class BootimgUbootPlugin(SourcePlugin):
    """
    Create partition for U-Boot.
    """
    ...
    @classmethod
    def _do_configure_grub_legacy(cls, hdddir, creator, cr_workdir,
                                 source_params):
        """
    ...
    def do_configure_partition(cls, part, source_params, creator, cr_workdir,
        ...
        # exec_cmd(install_cmd)
        # cls._do_configure_grub_legacy(hdddir, creator, cr_workdir, source_params)
