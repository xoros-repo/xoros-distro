...
qemu_command="echo 'Starting QEMU...' && export LIBVIRT_DEFAULT_URI='qemu:///system' && \
virt-install \
  --import \
  --name $vm \
  ...
  --force \
  --noautoconsole \
  --disk \$(readlink -f ${REMOTE_DIR}/build/tmp/deploy/images/qemux86-64/xoros-image-devel-qemux86-64.wic.vmdk)"
